        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12">
          ...
          <div className="text-center text-white">
            <h2 className="text-3xl font-bold mb-4">
              Finanças a dois, sucesso garantido
            </h2>
            <p className="text-lg text-white/80 max-w-md">
              Organize suas receitas, despesas e metas financeiras juntos.
              Porque planejar o futuro é melhor quando se faz em equipe.
            </p>
          </div>
          ...
          <div className="mt-12 flex gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-white/70 text-sm">Mais controle</div>
            </div>
            <div className="text-center">
